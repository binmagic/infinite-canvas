export default {
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI format", gemini: "Gemini format", imageDashscope: "DashScope Qwen Image / Z-Image: synchronous text-to-image and image editing, POST /services/aigc/multimodal-generation/generation, one request returns the image URL directly with no polling.", availableImageDashscope: "Available: prompt, images(dataURL[]), params{size,count}, model, baseUrl, apiKey" },
        authoring: {
    ...
    canvas: {
        ...
        editors: {
            ...
            maskTitle: "Local mask edit", maskHint: "Mouse wheel to zoom · middle button or Space + left drag to pan · Alt + left/right drag to resize brush · Ctrl/Cmd+Z to undo · Ctrl/Cmd+Shift+Z to redo", brush: "Brush", erase: "Erase", undoMaskTitle: "Undo mask stroke (Ctrl/Cmd+Z)", undoMask: "Undo mask stroke", redoMaskTitle: "Redo mask stroke (Ctrl/Cmd+Shift+Z)", redoMask: "Redo mask stroke", brushSize: "Brush size", editInstructions: "Edit instructions", maskPlaceholder: "For example: change the selected area to metal while preserving the original lighting", maskPromptRequired: "Enter edit instructions", maskRequired: "Paint the area to edit first", aiEdit: "Edit with AI", maskExport: "Export to canvas", maskGenerate: "Generate now",
            annotateTitle: "Annotation edit", annotateHint: "Mouse wheel to zoom · middle button or Space + left drag to pan · drag in the padded margin or on the image to draw an arrow · click an arrow to select it, drag its tip to adjust it · Ctrl/Cmd+Z to undo · Ctrl/Cmd+Shift+Z to redo", annotateRequired: "Add an arrow annotation first", annotateDefaultInstruction: "Edit the image according to the arrow annotations.", undoAnnotateTitle: "Undo annotation (Ctrl/Cmd+Z)", undoAnnotate: "Undo annotation", redoAnnotateTitle: "Redo annotation (Ctrl/Cmd+Shift+Z)", redoAnnotate: "Redo annotation", arrowColorLabel: "Arrow color", deleteArrowTitle: "Delete this arrow", arrowDescriptionPlaceholder: "Describe the change for this arrow", arrowDashDraw: "Draw", arrowDashDashed: "Dashed", arrowDashDotted: "Dotted", arrowDashSolid: "Solid", arrowSizeS: "S", arrowSizeM: "M", arrowSizeL: "L", arrowSizeXL: "XL", arrowKindArc: "Arc", arrowKindElbow: "Elbow",
