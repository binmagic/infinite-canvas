export default {
    ...
    canvas: {
        ...
        editors: {
            ...
            annotateTitle: "Annotation edit", annotateHint: "Mouse wheel to zoom · middle button or Space + left drag to pan · drag to draw an arrow, click to place a text annotation · Ctrl/Cmd+Z to undo · Ctrl/Cmd+Shift+Z to redo", arrowTool: "Arrow", textTool: "Text", annotateTextPlaceholder: "Enter annotation text", annotatePlaceholder: "For example: change the area the arrow points to into blue", annotatePromptRequired: "Enter edit instructions", annotateRequired: "Add an arrow or text annotation first", undoAnnotateTitle: "Undo annotation (Ctrl/Cmd+Z)", undoAnnotate: "Undo annotation", redoAnnotateTitle: "Redo annotation (Ctrl/Cmd+Shift+Z)", redoAnnotate: "Redo annotation",
