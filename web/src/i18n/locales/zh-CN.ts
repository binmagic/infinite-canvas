export default {
    ...
    canvas: {
        ...
        editors: {
            ...
            annotateTitle: "标注编辑", annotateHint: "滚轮缩放 · 中键或空格+左键拖动画面 · 拖拽画箭头，点击放置文字标注 · Ctrl/Cmd+Z 撤回 · Ctrl/Cmd+Shift+Z 重做", arrowTool: "箭头", textTool: "文字", annotateTextPlaceholder: "输入标注文字", annotatePlaceholder: "例如：把箭头指的区域改成蓝色", annotatePromptRequired: "请输入修改要求", annotateRequired: "请先添加箭头或文字标注", undoAnnotateTitle: "撤回标注 (Ctrl/Cmd+Z)", undoAnnotate: "撤回标注", redoAnnotateTitle: "重做标注 (Ctrl/Cmd+Shift+Z)", redoAnnotate: "重做标注",
