export default {
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI 规范", gemini: "Gemini 规范", imageDashscope: "DashScope 通义万相 / Z-Image：同步文生图/图生图，POST /services/aigc/multimodal-generation/generation，一次请求直接拿图片 URL，无需轮询。", availableImageDashscope: "可用：prompt、images(dataURL[])、params{size,count}、model、baseUrl、apiKey" },
        authoring: {
    ...
    canvas: {
        ...
        imageTools: { copyPrompt: "复制提示词", copyPromptTitle: "复制生成该图片的提示词", reversePrompt: "反推提示词", reversePromptTitle: "创建反推提示词的文本和配置节点", replace: "替换图片", locked: "锁比例", free: "自由比例", lockTitle: "切换为等比缩放", freeTitle: "切换为自由比例", mask: "局部编辑", maskTitle: "添加蒙版遮罩后局部修改", annotate: "标注编辑", annotateTitle: "画箭头和文字标注后按标注修改", crop: "裁剪", cropTitle: "裁剪并生成新节点", split: "切图", splitTitle: "按行列切分图片", upscale: "放大", upscaleTitle: "放大图片分辨率", superResolve: "超分", superResolveTitle: "AI 超分", angle: "多角度", angleTitle: "生成角度", view: "查看大图", viewTitle: "查看图片详情", more: "更多", configure: "配置快捷工具", customize: "自定义工具栏", showLabels: "显示按钮文字", description: "选择你想在图片节点编辑栏中使用的快捷工具。", preview: "节点预览", imageNode: "图片节点", quickTools: "快捷工具" },
        ...
        editors: {
            ...
            maskTitle: "局部遮罩编辑", maskHint: "滚轮缩放 · 中键或空格+左键拖动画面 · Alt+左/右键横拖调笔刷 · Ctrl/Cmd+Z 撤回 · Ctrl/Cmd+Shift+Z 重做", brush: "画笔", erase: "擦除", undoMaskTitle: "撤回局部涂抹 (Ctrl/Cmd+Z)", undoMask: "撤回局部涂抹", redoMaskTitle: "重做局部涂抹 (Ctrl/Cmd+Shift+Z)", redoMask: "重做局部涂抹", brushSize: "笔刷大小", editInstructions: "修改要求", maskPlaceholder: "例如：把选中区域改成金属材质，保持原图光影", maskPromptRequired: "请输入修改要求", maskRequired: "请先涂抹局部区域", aiEdit: "AI 修改", maskExport: "导出到画布", maskGenerate: "立刻生成",
            annotateTitle: "标注编辑", annotateHint: "滚轮缩放 · 中键或空格+左键拖动画面 · 在图片或四周留白区域拖拽画箭头 · 点击箭头可选中，拖动箭头端点可调整位置 · Ctrl/Cmd+Z 撤回 · Ctrl/Cmd+Shift+Z 重做", annotateRequired: "请先添加箭头标注", annotateDefaultInstruction: "请按标注箭头修改图片。", undoAnnotateTitle: "撤回标注 (Ctrl/Cmd+Z)", undoAnnotate: "撤回标注", redoAnnotateTitle: "重做标注 (Ctrl/Cmd+Shift+Z)", redoAnnotate: "重做标注", arrowColorLabel: "箭头颜色", deleteArrowTitle: "删除这条箭头", arrowDescriptionPlaceholder: "填写这条箭头的修改描述", arrowDashDraw: "手绘", arrowDashDashed: "虚线", arrowDashDotted: "点线", arrowDashSolid: "实线", arrowSizeS: "细", arrowSizeM: "中", arrowSizeL: "粗", arrowSizeXL: "特粗", arrowKindArc: "弧线", arrowKindElbow: "直角",
